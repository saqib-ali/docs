...
import social_network_city_graph from '/snippets/social-network_city.mdx';
...
Suppose we are interested in the Geometric Mean Income of all the people who live in the same city as Fatima. The formula for Geometric Mean is 
...
Note that we first use the COLLECT_LIST to get all the people who live in the same city as Fatima in a LIST. 
