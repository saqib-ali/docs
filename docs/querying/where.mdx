...
WHERE clause allows for filtering during the [MATCH](/docs/querying/match) phase. Compare this to the [FILTER](/docs/querying/filter) statment which allows results to be filtered after previous steps.
